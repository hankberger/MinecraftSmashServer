...
**Points:** finishing a multiplayer match earns **50**, plus **25** for a win. Draws earn 50 each. Practice and leaving while still fighting earn none; leaving after losing your final stock still counts as finishing. Balances persist across restarts and arena transfers. The lobby and character picker show your balance, results show your reward, and `/smash points` shows your balance and lifetime earnings. Points are being saved for future cosmetics and fighter unlocks; all five fighters remain available. See [POINTS.md](POINTS.md) for reward rules, persistence and operations.
