...
final class MapWorldTest {
    ...
    static void verifyArena(MinecraftServer server) {
        ...
        // Simulate a rollback: the old builder reinstates its marker but leaves the newer one below its clearing area.
        ...
        check(arena.getBlockState(new BlockPos(1,40,0)).is(Blocks.REINFORCED_DEEPSLATE), "New revision marker stays below the blast zone");
